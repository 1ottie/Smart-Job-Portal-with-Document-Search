...
import axiosClient from "../utils/axiosClient"; // đảm bảo file này tồn tại và dùng accessToken
import "./Dashboard.css";
import logo from "../assets/logo.png"; 

function Dashboard() {
  const navigate = useNavigate();
  const location = useLocation(); // thêm để active menu
  ...
  // State cho thanh tìm kiếm topbar
    ...
    <div className="container">
            ...
            {isProfilePopupOpen && (
              <div className="profile-popup">
                ...
                <div className="profile-footer">
                  <button className="btn-danger popup-btn logout-btn" onClick={handleLogout}>
                    Đăng xuất
                  </button>
                </div>
              </div>
      ...
      <div className="main-layout">
        <div className={`sidebar ${isSidebarOpen ? "" : "closed"}`}>
          <h3>Menu</h3>
          <p onClick={() => navigate("/dashboard")} className={location.pathname === "/dashboard" ? "active-menu" : ""}>
            Dashboard
          </p>
          <p onClick={() => navigate("/jobs")} className={location.pathname === "/jobs" ? "active-menu" : ""}>
            Jobs
          </p>
          <p onClick={() => navigate("/candidates")} className={location.pathname === "/candidates" ? "active-menu" : ""}>
            Candidates
          </p>
          ...
          <div className="account-modal-container" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="account-sidebar">
              ...
              <ul className="account-menu">
                ...
                {user?.role === "recruiter" ? (
                  <li className={activeTab === "my-jobs" ? "active" : ""} onClick={() => setActiveTab("my-jobs")}>
                    Bài tuyển dụng
                  </li>
                ) : (
                  <li className={activeTab === "my-cv" ? "active" : ""} onClick={() => setActiveTab("my-cv")}>
                    Hồ sơ (CV)
                  </li>
                )}
                ...
                <>
                  ...
                  <div className="account-content-body">
                    ...
                    <div className="account-avatar-section">
                      <div className="avatar-preview">{user?.name ? user.name.charAt(0).toUpperCase() : "U"}</div>
